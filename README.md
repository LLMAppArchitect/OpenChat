...
## 查看 NVIDIA Driver Version & CUDA Version: 12.2
...
python -m ochat.serving.openai_api_server --model openchat/openchat_3.5 --engine-use-ray --worker-use-ray --tensor-parallel-size 2
```
